...
export interface Site {
  ...
  profile: {
    name: string;
    /**
     * Несколько слов, которые посетители увидят под вашим именем.
     */
    bio?: string | null;
    /**
     * Можно оставить пустой, чтобы убрать подпись.
     */
    footerNote?: string | null;
    avatar?: (number | null) | Media;
    background?: (number | null) | Media;
    /**
     * Загрузка из медиатеки имеет приоритет над этой ссылкой.
     */
  ...
  contentLinks?:
    | {
        label: string;
        /**
         * Полный адрес, например https://example.com
         */
        url: string;
        icon: string;
        id?: string | null;
